...
class RoleController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $role = Role::find($id);
        $permissions= Permission::get();
        $rolePermission = DB::table('permission_role')->where('permission_role.role_id',            $id)->pluck('permission_role.permission_id','permission_role.permission_id')->toArray();

        return view('admin.roles.edit', compact('role', 'permissions', 'rolePermission'));
    }
